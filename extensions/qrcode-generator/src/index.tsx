import { Action, ActionPanel, closeMainWindow, Form, open, PopToRootType, showToast, Toast } from "@raycast/api";
...
export default function Command() {
  ...
  const renderActions = () => {
    const copyAndCloseAction = (
      <Action.SubmitForm
        title="Copy QR Code and Close"
        shortcut={{ modifiers: [], key: "enter" }}
        onSubmit={async (values) => {
          await handleSubmit({ ...values, inline: false, copy: true, closeAfterCopy: true } as FormValues);
        }}
      />
    );
