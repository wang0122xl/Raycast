...
import { Action, ActionPanel, closeMainWindow, getPreferenceValues, Keyboard, Icon, popToRoot } from "@raycast/api";
...
function HistoryItemActions({
  ...
  return (
    <ActionPanel title={title}>
      <Action
        onAction={async () => {
          const opened = await openNewTab({ url, profileOriginal, profileCurrent, openTabInProfile });
          if (opened) {
            await closeMainWindow();
          }
        }}
