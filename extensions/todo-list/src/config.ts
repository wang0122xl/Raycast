...
import type { TodoSections, TodoItem } from "./atoms";
export const TODO_STORAGE_PATH = path.join(os.homedir(), "git", "Raycast", "assets", "todo-list");
export const TODO_FILE = path.join(TODO_STORAGE_PATH, "todo.json");
export const TODO_MANIFEST_FILE = path.join(TODO_STORAGE_PATH, "todo-manifest.json");
export const TODO_CURRENT_FILE = path.join(TODO_STORAGE_PATH, "todo-current.ndjson");
export const TODO_EVENTS_PREFIX = "todo-events-";
export const TODO_EVENTS_EXTENSION = ".ndjson";
export const TODO_EVENTS_MAX_BYTES = 5 * 1024 * 1024;
export const COMPLETED_VISIBLE_DAYS = 15;
